                ...
                <div class="card-box">
                    ...
                    <form id="<?php echo (($method=="edit")?"$frm_id":"$frm_id");?>" class="form-horizontal" role="form" >
                          <div class="form-group row">
                              ...
                              <div class="col-9">
                                  <input placeholder="COLOR NAME" type="text" name="name" required="" class="form-control" autocomplete="off" value="<?php echo (($method=="edit")?$result->color_name:"");  ?>">
                              </div>
                          </div>
                        <?php if($method=="edit"): ?> 
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                ...
                                <?php echo (($method=="edit")?'<input type="hidden" name="id" value="'.$result->color_id .'">':""); ?>
                            </div>
                        </div>
                        <?php endif; ?>
      ...
      <?php endif; ?>
       $('#datatable-buttons').on('click', '[data-id=delete]', function () {                        
            ...
            swal({
                ...
                $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('Color/delete/');?>"+id+"",
